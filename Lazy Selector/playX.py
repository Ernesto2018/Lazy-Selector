...
class Counta():
    ...
    def __init__(self, workingdir, dst=".", clean: list=None):
        ...
        # self.__rename_section(basename(workingdir.replace("[", "").replace("]", "")), self.sectionName)
    ...
    def __rename_section(self, sect: str, new_sect: str):
...
if __name__ == '__main__':
    ...
    c = Counta(".")
    print("Frequency B:", c.get_freq(file))

    c.log_item(file, c.get_freq(file) + 1)

    print("Frequency A:", c.get_freq(file))
